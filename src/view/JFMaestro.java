 ...
 * @author Marco
 */
public class JFMaestro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblbienvenida.setText("Bienvenido maestro");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFMaestro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
